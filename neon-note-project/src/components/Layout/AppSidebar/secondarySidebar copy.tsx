      ...
      <div className={`flex-col mt-6 gap-4 flex`}>
        ...
        <div className='flex flex-col' onClick={openSubFolders}>
          <div className='w-full mb-2 flex justify-between items-center'>
            <h1 className='text-xl font-bold text-black-800'>testando</h1>
        ...
        <ModalComponent onClose={onCloseAddFolder} isOpen={isOpenAddFolder}>
          <div className='flex flex-col gap-4'>
            ...
            <div className='flex gap-4'>
                <ButtonComponent onClick={handleAddFolder} text='Adicionar' className='bg-green-500' />
                <ButtonComponent onClick={onCloseAddFolder} text='Cancelar' className='bg-red-500' />
            </div>
          </div>
        </ModalComponent>
      )}
